...
//   const [selectedSubmenu, setSelectedSubmenu] = useState(null); // Track the selected submenu
...
//                     <div
//                       key={subIndex}
//                       className="py-3 px-2 hover:bg-gray-400 cursor-pointer w-52 h-8 justify-center"
//                     >
//                       {subitem}
//                     </div>
//                   ))}
...
//         </nav>
//       </header>
//       {/* Conditionally render the Bed component based on the selected submenu */}
//       {selectedSubmenu === "BED INFO" && <Bed />}
//     </>
//   );
// };
...
const Header = () => {
  const menuItems = [
    { name: 'FILE MASTER', submenu: ['SERVICE ITEMS', 'MEDICINE ITEMS', 'MEDICAL TEST NAME', 'PATIENTS REGISTER', 'DOCTOR DETAILS', 'SISTER DETAILS', 'STAFF INFO', 'BED INFO', 'PACKAGE INFO', 'SUPPLIERS INFORMATION', 'LEDGER CREATION', 'HOSPITAL INFO.'] },
    { name: 'DATA ENTRY', submenu: ['MEDICINE APPLY', 'OPERATION (O.T) ENTRY', 'OTHER CHARGES', 'BIRTH/DELIVERY CASE', 'DEATH CASE', 'PATIENT DISCHARGE', 'REFERRAL ENTRY', 'PURCHASE BILL (MEDICINE)', 'MEDICINE STOCK ENTRY', 'DAILY USES ENTRY', 'DR. VISIT (INDOOR)', 'DR. VISIT (OUTDOOR)', 'GENERAL PAYMENT', 'PATIENT PAYMENT', 'GENERAL RECEIPT', 'CASH DEPOSIT', 'CASH'] },
    { name: 'REPORT', submenu: ['', ''] },
    { name: 'AUDIT & ACCOUNTS', submenu: ['Subitem 1', 'Subitem 2'] },
    { name: 'UTILITY', submenu: ['Subitem 1', 'Subitem 2'] },
  ];
